...
const viewerOptions = {
    ...
    // 1.001 closes all three pairs of cell faces; set 1.0 for the canonical,
    // Z-correct [0,1) cell with far-face atoms wrapped back in.
    'packingCutoff': 1.001,

    // Difference-electron-density maps are loaded separately from the
    // coordinate CIF and remain opt-in. Density sections use their canonical
    // public defaults directly so the viewer and numerical API cannot drift.
    'differenceDensity': DEFAULT_DIFFERENCE_DENSITY_OPTIONS,

    'scalarField': DEFAULT_SCALAR_FIELD_OPTIONS,

    'isosurface': DEFAULT_ISOSURFACE_OPTIONS,
    ...
    'contourLines': DEFAULT_CONTOUR_LINE_OPTIONS,
...
export const DEFAULT_VIEWER_OPTIONS = deepFreeze(viewerOptions);
