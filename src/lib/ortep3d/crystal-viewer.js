...
export class CrystalViewer {
    ...
    loadDifferenceDensityInWorker(fcfText, fcfBlock, loadId) {
        return new Promise(resolve => {
            ...
            worker.postMessage({
                ...
                fftBackend: this.options.differenceDensity.fftBackend,
                fftGridPlanner: this.options.differenceDensity.fftGridPlanner,
                fftAxisKernel: this.options.differenceDensity.fftAxisKernel,
                realTransform: this.options.differenceDensity.realTransform,
                symmetryReducedFft: this.options.differenceDensity.symmetryReducedFft,
    ...
    applyProgressiveScalarField(field, message) {
        ...
        this.notifyScalarFieldUpdate({
            ...
            symmetryReducedFft: field.symmetryReducedFft,
            symmetryReducedStorage: field.symmetryReducedStorage ?? false,
            symmetryRepresentativeCount: field.symmetryRepresentativeCount,
            symmetryOrbitResidual: field.symmetryOrbitResidual,
            symmetryStorageBytes: field.symmetryStorageBytes,
            ...
            cacheHitCellCount: surfaceStatistics.cacheHitCellCount ?? 0,
            cacheMissCellCount: surfaceStatistics.cacheMissCellCount ?? 0,
            generatedCellCount: surfaceStatistics.generatedCellCount ?? 0,
            reusedCellCount: surfaceStatistics.reusedCellCount ?? 0,
            patchCacheBytes: surfaceStatistics.patchCacheBytes ?? 0,
            patchCacheEvictionCount: surfaceStatistics.patchCacheEvictionCount ?? 0,
